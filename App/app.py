...
if page == "overview":
    ...
    with col_w:
        ...
        <div class="winner-card">
            ...
            <div style="font-size:28px; font-weight:700; color:#8b5cf6; margin-top:4px;">94.61%</div>
    ...
    with col_s:
        ...
        <div class="metric-card">
            ...
            <div style="font-size:26px; font-weight:700; color:#f59e0b; margin-top:4px;">92.38%</div>
            <div style="font-size:12px; color:#64748b; margin-top:2px;">Accuracy</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_b:
        ...
        <div class="metric-card">
            ...
            <div style="font-size:26px; font-weight:700; color:#06b6d4; margin-top:4px;">90.11%</div>
            <div style="font-size:12px; color:#64748b; margin-top:2px;">Accuracy</div>
        </div>
        """, unsafe_allow_html=True)
